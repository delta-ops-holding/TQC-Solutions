...
namespace DiscordBot.Interfaces
{
    public class NotificationService : INotifier
    {
        ...
        public async Task NotifyAdminAsync(byte platformId, IUser discordUser, Enums.Clan clanName)
        {
            // Channel to post to.
        ...
        public async Task NotifyUserAsync(IUser discordUser, Enums.Clan clanName)
        {
            try
            {
