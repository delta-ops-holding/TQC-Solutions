    ...
    public class DataService
    {
        ...
        public Name.ClanNames GetClanName(IEmote emote)
        {
            ...
            return e.Id switch
            {
                ...
                772951082544267284 => Name.ClanNames.MΔJESTIC,
                ...
                772951082326163457 => Name.ClanNames.IMMORTΔL,
        ...
        public string GetPingRole(Name.ClanNames clanName)
        {
            return clanName switch
            {
                ...
                Name.ClanNames.MΔJESTIC => "<@&772933170781749258>",
                ...
                Name.ClanNames.IMMORTΔL => "<@&772933700681859123>",
